...
;; supply and awards them to the BDE005 Dev Fund extension. It contains a number of
...
(define-public (execute (sender principal))
	(let
		(
			(total-supply (unwrap-panic (contract-call? .bde000-governance-token get-total-supply)))
		...
		(contract-call? .bde000-governance-token edg-mint dev-fund-amount .bde005-dev-fund)
	)
)
